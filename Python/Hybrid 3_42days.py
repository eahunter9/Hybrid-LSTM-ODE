...
dataset_mobility= pd.read_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/mobility_20202021.csv")

train_mobility = dataset_mobility[['residential_percent_change_from_baseline']][0:300]
val_mobility =  dataset_mobility[['residential_percent_change_from_baseline']][301:357]
#val_ode =  dataset_ode[['measurement']][316:395]

train_mobility = TimeSeries.from_dataframe(train_mobility)
val_mobility = TimeSeries.from_dataframe(val_mobility)

dataset_survey= pd.read_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/average concern.csv")



train_concern = dataset_survey[['x']][0:300]
val_concern =  dataset_survey[['x']][301:357]
#val_ode =  dataset_ode[['measurement']][316:395]

train_concern = TimeSeries.from_dataframe(train_concern)
val_concern = TimeSeries.from_dataframe(val_concern)
dataset_survey= pd.read_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/stay_at_home.csv")



train_stayathome = dataset_survey[['x']][0:300]
val_stayathome  =  dataset_survey[['x']][301:357]
#val_ode =  dataset_ode[['measurement']][316:395]

train_stayathome  = TimeSeries.from_dataframe(train_stayathome )
val_stayathome  = TimeSeries.from_dataframe(val_stayathome )

#dataset_ode= pd.read_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/nocohort_ABMrestrictions.csv")
dataset_ode= pd.read_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/behaviour_findrestrictions_timeseries.csv")



train_ode = dataset_ode[['measurement']][0:300]
val_ode =  dataset_ode[['measurement']][301:357]
#val_ode =  dataset_ode[['measurement']][316:395]

train_ode = TimeSeries.from_dataframe(train_ode)
val_ode = TimeSeries.from_dataframe(val_ode)
...
past_covariates_train =train_mobility
past_covariates_val =val_mobility


past_covariates_train = concatenate([train_ode,train_mobility, train_concern,train_stayathome], axis=1)
past_covariates_val = concatenate([val_ode,val_mobility, val_concern,val_stayathome], axis=1)

my_model = BlockRNNModel(
    input_chunk_length=27,#29,
...
def eval_model(model):
    pred_series = model.predict(n=42, num_samples=500,past_covariates = past_covariates_train)
   ...
   # series_transformed.plot(label="actual")
    ...
    plt.title("Hybrid 2: 42 Day Prediction Period")#f"MAPE: {mape(pred_series, val_transformed):.2f}%")
...
pred_series = my_model.predict(n=42, num_samples=500,past_covariates = past_covariates_train)
pred_lower = pred_series.quantile(0.025)
pred_lower = transformer.inverse_transform(pred_lower)
pred_lower.to_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/behaviour_ode_alldata_42_lower.csv")

pred_upper = pred_series.quantile(0.975)
pred_upper = transformer.inverse_transform(pred_upper)
pred_upper.to_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/behaviour_ode_alldata_42_upper.csv")

pred_median = pred_series.quantile(0.5)
pred_median = transformer.inverse_transform(pred_median)
pred_median.to_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/behaviour_ode_alldata_42_median.csv")

...
train_ode = dataset_ode[['measurement']][0:350]
val_ode =  dataset_ode[['measurement']][301:395]
...
train_ode_l = dataset_ode[['lower_bound']][0:300]
val_ode_l =  dataset_ode[['lower_bound']][301:395]
#val_ode_l =  dataset_ode[['lower_bound']][316:395]

train_ode_l = TimeSeries.from_dataframe(train_ode_l)
val_ode_l = TimeSeries.from_dataframe(val_ode_l)




train_ode_u = dataset_ode[['upper_bound']][0:300]
val_ode_u =  dataset_ode[['upper_bound']][301:395]
#val_ode_u =  dataset_ode[['upper_bound']][316:395]

train_ode_u = TimeSeries.from_dataframe(train_ode_u)
val_ode_u = TimeSeries.from_dataframe(val_ode_u)
...
train_ode_transformed = transformer.fit_transform(train_ode)
val_ode_transformed = transformer.transform(val_ode)
...
past_covariates_train =train_ode
past_covariates_val =val_ode

my_model = BlockRNNModel(
    input_chunk_length=28,#28
    output_chunk_length=14,#42,
    model="LSTM",
    hidden_dim=25,#25
    dropout=0,
    n_rnn_layers=7,#7
...
def eval_model(model):
   ...
   # series_transformed.plot(label="actual")
    ...
    #plt.title("Hybrid 1: 42 Day Prediction Period")#f"MAPE: {mape(pred_series, val_transformed):.2f}%")
...
pred_lower.to_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/behaviour_ode_42_lower.csv")

pred_upper = pred_series.quantile(0.975)
pred_upper = transformer.inverse_transform(pred_upper)
pred_upper.to_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/behaviour_ode_42_upper.csv")

pred_median = pred_series.quantile(0.5)
pred_median = transformer.inverse_transform(pred_median)
pred_median.to_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/behaviour_ode_42_median.csv")

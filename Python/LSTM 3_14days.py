...
def eval_model(model):
   ...
   # series_transformed.plot(label="actual")
    ...
    plt.title("LSTM 3: 14 Day Prediction Period")#f"MAPE: {mape(pred_series, val_transformed):.2f}%")
    plt.legend()
...
pred_lower.to_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/behaviour_stay_14_lower.csv")

pred_upper = pred_series.quantile(0.975)
pred_upper = transformer.inverse_transform(pred_upper)
pred_upper.to_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/behaviour_stay_14_upper.csv")

pred_median = pred_series.quantile(0.5)
pred_median = transformer.inverse_transform(pred_median)
pred_median.to_csv("C:/Users/Elizabeth/OneDrive - National University of Ireland, Galway/calibration/waningimmunity/delay/behaviour/behaviour_stay_14_median.csv")
